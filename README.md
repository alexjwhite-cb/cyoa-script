...
- Code folding for `story`, `event`, `effect`, and `choice` blocks (indentation-based, character offsets always provided, incremental text sync for fold-state preservation across edits)
